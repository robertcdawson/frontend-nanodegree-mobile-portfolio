...
// Create and append all of the pizzas when the page loads
...
// Make sliding pizza prototype
function makeSlidingPizza() {
  'use strict';
...
function makeSlidingPizzas(num) {
  'use strict';
  // make 200 pizzas if num is undefined
  var num = num ? num : 200;

  var pizza = makeSlidingPizza();
